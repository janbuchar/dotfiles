...
config.bind('pu', f'spawn --userscript {QUTE_RBW} --mode username-only')
config.bind('pW', f'spawn --userscript {QUTE_RBW} --mode password-only')
config.bind('po', f'spawn --userscript {QUTE_RBW} --mode otp')
